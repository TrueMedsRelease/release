...
(function (factory) {
    ...
    var factoryOutput = (() => {
        ...
        var A = (o, t) => {
            ...
            if (t && typeof t == "object" || typeof t == "function") for (let n of S(t)) !D.call(o, n) && n !== e && v(o, n, {
                get: () => t[n],
        ...
        var k = 0, T = {
            ...
            f = o => o.replace(/\D/g, ""),
            _ = (o = "") => o.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), P = (o, t, e) => {
                ...
                return !1
            }, H = (o, t) => o.name < t.name ? -1 : o.name > t.name ? 1 : 0, U = (o, t, e, i) => {
                if (e === 0 && !i) return 0;
                let n = 0;
                ...
                _e() {
                    ...
                    for (let t = 0; t < this.d.preferredCountries.length; t++) {
                        let e = this.d.preferredCountries[t].toLowerCase(), i = this._y(e, !0);
                ...
                _f() {
                    ...
                    let u = h("div", {class: c});
                    if (this.a.parentNode?.insertBefore(u, this.a), (i || e) && (this.k = h("div", {class: "iti__country-container"}, u), this.selectedCountry = h("button", {
                        type: "button",
                        class: "iti__selected-country", ...t && {
                            "aria-expanded": "false",
                            "aria-label": this.d.i18n.selectedCountryAriaLabel || "Selected country",
                            "aria-haspopup": a ? "true" : "listbox",
                            "aria-controls": a ? `iti-${this.id}__dropdown-content` : `iti-${this.id}__country-listbox`, ...a ? {role: "combobox"} : {}
                        }
                    }, this.k), this.l = h("div", null, this.selectedCountry), this.selectedCountryA11yText = h("span", {class: "iti__a11y-text"}, this.l)), u.appendChild(this.a), this.selectedCountry && this.a.disabled && this.selectedCountry.setAttribute("aria-disabled", "true"), e && (this.t = h("div", {class: "iti__selected-dial-code"}, this.selectedCountry)), t) {
                        this.a.disabled || this.selectedCountry.setAttribute("tabindex", "0"), this.u = h("div", {
                            class: "iti__arrow",
                            "aria-hidden": "true"
                        ...
                        if (this.dropdownContent = h("div", {
                            ...
                            autocomplete: "off"
                        }, this.dropdownContent), this.searchResultsA11yText = h("span", {class: "iti__a11y-text"}, this.dropdownContent)), this.countryList = h("ul", {
                            class: "iti__country-list",
                            id: `iti-${this.id}__country-listbox`,
                            role: "listbox",
                            "aria-label": p.countryListAriaLabel || "List of countries"
                        }, this.dropdownContent), this.preferredCountries.length && !a && (this._g(this.preferredCountries, "iti__preferred", !0), h("li", {
                            class: "iti__divider",
                            "aria-hidden": "true"
                        }, this.countryList)), this._g(this.p, "iti__standard"), a && this._p4(), r) {
                    ...
                    if (s) {
                        let m = this.a.getAttribute("name") || "", g = s(m);
                        g.phone && (this.hiddenInput = h("input", {
                            type: "hidden",
                            name: g.phone
                        }), u.appendChild(this.hiddenInput)), g.country && (this.hiddenInputCountry = h("input", {
                            type: "hidden",
                            name: g.country
                ...
                _g(t, e, i) {
                    for (let n = 0; n < t.length; n++) {
                        let s = t[n], r = i ? "-preferred" : "", d = h("li", {
                        ...
                        let l = "";
                        this.d.showFlags && (l += `<div class='iti__flag-box'><div class='iti__flag iti__${s.iso2}'></div></div>`), l += `<span class='iti__country-name'>${s.name}</span>`, l += `<span class='iti__dial-code'>+${s.dialCode}</span>`, d.insertAdjacentHTML("beforeend", l)
                    }
                }

                _h(t = !1) {
                    let e = this.a.getAttribute("value"), i = this.a.value,
                        s = e && e.charAt(0) === "+" && (!i || i.charAt(0) !== "+") ? e : i, r = this._5(s),
                        d = L(s), {initialCountry: l} = this.d;
                    if (r && !d) this._v(s); else if (l !== "auto" || t) {
                ...
                _i4() {
                    window.intlTelInputGlobals.autoCountry ? this.handleAutoCountry() : window.intlTelInputGlobals.startedLoadingAutoCountry || (window.intlTelInputGlobals.startedLoadingAutoCountry = !0, typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup((t = "") => {
                        let e = t.toLowerCase();
                    ...
                    this._a12 = n => {
                        ...
                        if (s || r && !t ? i = !0 : /[^+0-9]/.test(this.a.value) || (i = !1), e && !i) {
                            let d = this.a.selectionStart || 0,
                                ...
                                p = n && n.inputType === "deleteContentForward", c = this._9(), u = U(a, c, d, p);
                            this.a.value = c, this.a.setSelectionRange(u, u)
                        }
                    }, this.a.addEventListener("input", this._a12), t && (this._handleKeydownEvent = n => {
                        if (n.key.length === 1 && !n.altKey && !n.ctrlKey && !n.metaKey) {
                            let s = this.a.selectionStart === 0 && n.key === "+", r = /^[0-9]$/.test(n.key), d = s || r,
                                l = this._6(), a = window.intlTelInputUtils.getCoreNumber(l, this.s.iso2),
                ...
                _n() {
                    ...
                    if (t && (this.dropdownContent.style.width = `${this.a.offsetWidth}px`), this.dropdownContent.classList.remove("iti__hide"), this.selectedCountry.setAttribute("aria-expanded", "true"), this._o(), this.b && !e) this._x(this.b, !1), this._3(this.b, !0); else {
                ...
                _o() {
                    if (this.d.dropdownContainer && this.d.dropdownContainer.appendChild(this.dropdown), !this.d.useFullscreenPopup) {
                        let t = this.a.getBoundingClientRect(), e = document.documentElement.scrollTop, i = t.top + e,
                            n = this.dropdownContent.offsetHeight, s = i + this.a.offsetHeight + n < e + window.innerHeight,
                            r = i - n > e, d = !this.d.countrySearch && !s && r;
                ...
                _p() {
                    ...
                    let e = "", i = null;
                    if (this._a3 = n => {
                        ["ArrowUp", "ArrowDown", "Enter", "Escape"].includes(n.key) && (n.preventDefault(), n.stopPropagation(), n.key === "ArrowUp" || n.key === "ArrowDown" ? this._q(n.key) : n.key === "Enter" ? this._r() : n.key === "Escape" && this._2()), !this.d.countrySearch && /^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(n.key) && (n.stopPropagation(), i && clearTimeout(i), e += n.key.toLowerCase(), this._s(e), i = setTimeout(() => {
                            e = ""
                        }, 1e3))
                        ...
                        }, this.searchInput.addEventListener("input", this._a7), this.searchInput.addEventListener("click", r => r.stopPropagation())
                    }
                }
                ...
                _p3(t, e = !1) {
                    ...
                    for (let s = 0; s < this.p.length; s++) {
                        let r = this.p[s], d = _(r.name), l = `+${r.dialCode}`;
                ...
                _p4() {
                    ...
                    e === 0 ? i = t.zeroSearchResults || "No results found" : e === 1 ? i = t.oneSearchResult || "1 result found" : i = t.multipleSearchResults ? t.multipleSearchResults.replace("${count}", e.toString()) : `${e} results found`, this.searchResultsA11yText.textContent = i
                }
                ...
                _u(t) {
                    ...
                    if (this.d.formatOnDisplay && window.intlTelInputUtils && this.s) {
                        let i = this.d.nationalMode || e.charAt(0) !== "+" && !this.d.showSelectedDialCode, {NATIONAL: n, INTERNATIONAL: s} = window.intlTelInputUtils.numberFormat,
                            r = i ? n : s;
                ...
                _v(t) {
                    ...
                    let r = this._5(i, !0), d = f(i), l = null;
                    if (r) {
                        let a = this.q[f(r)], p = a.indexOf(this.s.iso2) !== -1 && d.length <= r.length - 1;
                        if (!(n === "1" && L(d)) && !p) {
                            for (let u = 0; u < a.length; u++) if (a[u]) {
                                l = a[u];
                                break
                            }
                        }
                ...
                _z(t) {
                    ...
                    if (this.s = t ? this._y(t, !1) || {} : {}, this.s.iso2 && (this.j = this.s.iso2), this.l) {
                        let l = "", a = "";
                        t ? n && (l = `iti__flag iti__${t}`, a = `${this.s.name} +${this.s.dialCode}`) : (l = "iti__flag iti__globe", a = r.noCountrySelected || "No country selected"), this.l.className = l, this.selectedCountryA11yText.textContent = a
                    }
                    if (this._z3(t, i), i) {
                ...
                _updateMaxLength() {
                    if (this.d.strictMode && window.intlTelInputUtils) if (this.s.iso2) {
                        let t = window.intlTelInputUtils.numberType[this.d.placeholderNumberType],
                            e = window.intlTelInputUtils.getExampleNumber(this.s.iso2, !1, t, !0), i = e;
                ...
                _3(t, e) {
                    let i = this.countryList, n = document.documentElement.scrollTop, s = i.offsetHeight,
                        r = i.getBoundingClientRect().top + n, d = r + s, l = t.offsetHeight,
                        a = t.getBoundingClientRect().top + n, p = a + l, c = a - r + i.scrollTop, u = s / 2 - l / 2;
                    if (a < r) e && (c -= u), i.scrollTop = c; else if (p > d) {
                        e && (c += u);
                        let m = s - l;
                        i.scrollTop = c - m
                    }
                    ...
                    if (t.charAt(0) === "+") {
                        ...
                        for (let s = 0; s < t.length; s++) {
                            ...
                            if (!isNaN(parseInt(r, 10))) {
                                if (n += r, e) this.q[n] && (i = t.substr(0, s + 1)); else if (this.dialCodes[n]) {
                                    i = t.substr(0, s + 1);
                                    break
                                }
                ...
                _6() {
                    let t = this.a.value.trim(), {dialCode: e} = this.s, i, n = f(t);
                ...
                _9() {
                    let t = this._6(),
                        e = window.intlTelInputUtils ? window.intlTelInputUtils.formatNumberAsYouType(t, this.s.iso2) : t, {dialCode: i} = this.s;
                ...
                }, i.className = "iti-load-utils", i.async = !0, i.src = o, document.body.appendChild(i)
            },
