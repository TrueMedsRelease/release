...
$('#card_numb').bind('change', function(e) {     
    ...
    var success_trans = $("#success_trans").val();
    let billing_country = $("#billing_country option:selected").val();
    // if (billing_country == "US" || billing_country == "CA" || success_trans == 1/* || billing_country == "AU" || billing_country == "DE" || billing_country == "FR" || billing_country == "GB" || billing_country == "IT" || billing_country == "ES" || billing_country == "FI" || billing_country == "DK"*/) {
...
function changeWithGiftCard(className, paymentTypeChange, currPaymentType) {
    let change_type = '';
    $('.card_type .select__option').each(function (index, element) {
        if (index == 0) {
            change_type = $(element).attr('data-value');
            return false;
        }
    });

    if (paymentTypeChange == '') {
        paymentTypeChange = change_type;
    }

    if (paymentTypeChange != currPaymentType) {
        if ($('#' + className).val() > 0) {
            $('#payment_type_select').prop('disabled', false);
            $('#payment_type_select option[value="' + paymentTypeChange + '"]').prop('selected', true);
            $('.select__option[data-value="' + paymentTypeChange + '"]').click();
            $('.card_type .select').removeClass('_select-open');
            $('.select__options').attr('hidden', 'hidden');
        } else {
            $('#payment_type_select option[value="gift_card"]').prop('selected', true);
            $('.select__option[data-value="gift_card"]').click();
...
function secretPackage() {
    ...
    if (payment_type == "paypal") {
        $('#discount_text').text($('#discount_paypal').val());
        if (ins == 1) {
            if (secret == 1) {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_secret_ems_paypal').val());
                    $('#total_old').text($('#sum_ins_secret_ems_old').val());
                    $('#saving').text($('#sum_ins_secret_ems_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_secret_ems_paypal').val());

                    changeWithGiftCard('rest_total_sum_ins_secret_ems_paypal', 'paypal', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_secret_reg_paypal').val());
                    $('#total_old').text($('#sum_ins_secret_reg_old').val());
                    $('#saving').text($('#sum_ins_secret_reg_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_secret_reg_paypal').val());

                    changeWithGiftCard('rest_total_sum_ins_secret_reg_paypal', 'paypal', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_ems_paypal').val());
                    $('#total_old').text($('#sum_ins_ems_old').val());
                    $('#saving').text($('#sum_ins_ems_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_ems_paypal').val());

                    changeWithGiftCard('rest_total_sum_ins_ems_paypal', 'paypal', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_reg_paypal').val());
                    $('#total_old').text($('#sum_ins_reg_old').val());
                    $('#saving').text($('#sum_ins_reg_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_reg_paypal').val());

                    changeWithGiftCard('rest_total_sum_ins_reg_paypal', 'paypal', $(".card_type option:selected").val());
                }
            }
        } else {
            if (secret == 1) {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_secret_ems_paypal').val());
                    $('#total_old').text($('#sum_secret_ems_old').val());
                    $('#saving').text($('#sum_secret_ems_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_secret_ems_paypal').val());

                    changeWithGiftCard('rest_total_sum_secret_ems_paypal', 'paypal', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_secret_reg_paypal').val());
                    $('#total_old').text($('#sum_secret_reg_old').val());
                    $('#saving').text($('#sum_secret_reg_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_secret_reg_paypal').val());

                    changeWithGiftCard('rest_total_sum_secret_reg_paypal', 'paypal', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ems_paypal').val());
                    $('#total_old').text($('#sum_ems_old').val());
                    $('#saving').text($('#sum_ems_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ems_paypal').val());

                    changeWithGiftCard('rest_total_sum_ems_paypal', 'paypal', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_reg_paypal').val());
                    $('#total_old').text($('#sum_reg_old').val());
                    $('#saving').text($('#sum_reg_save_paypal').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_reg_paypal').val());

                    changeWithGiftCard('rest_total_sum_reg_paypal', 'paypal', $(".card_type option:selected").val());
                }
            }
        }
    } else if (payment_type == "crypto") {
        $('#discount_text').text($('#discount_crypto').val());
        if (ins == 1) {
            if (secret == 1) {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_secret_ems_crypto').val());
                    $('#total_old').text($('#sum_ins_secret_ems_old').val());
                    $('#saving').text($('#sum_ins_secret_ems_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_ins_secret_ems_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_secret_ems_crypto').val());

                    changeWithGiftCard('rest_total_sum_ins_secret_ems_crypto', 'crypto', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_secret_reg_crypto').val());
                    $('#total_old').text($('#sum_ins_secret_reg_old').val());
                    $('#saving').text($('#sum_ins_secret_reg_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_ins_secret_reg_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_secret_reg_crypto').val());

                    changeWithGiftCard('rest_total_sum_ins_secret_reg_crypto', 'crypto', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_ems_crypto').val());
                    $('#total_old').text($('#sum_ins_ems_old').val());
                    $('#saving').text($('#sum_ins_ems_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_ins_ems_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_ems_crypto').val());

                    changeWithGiftCard('rest_total_sum_ins_ems_crypto', 'crypto', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_reg_crypto').val());
                    $('#total_old').text($('#sum_ins_reg_old').val());
                    $('#saving').text($('#sum_ins_reg_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_ins_reg_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_reg_crypto').val());

                    changeWithGiftCard('rest_total_sum_ins_reg_crypto', 'crypto', $(".card_type option:selected").val());
                }
            }
        } else {
            if (secret == 1) {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_secret_ems_crypto').val());
                    $('#total_old').text($('#sum_secret_ems_old').val());
                    $('#saving').text($('#sum_secret_ems_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_secret_ems_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_secret_ems_crypto').val());

                    changeWithGiftCard('rest_total_sum_secret_ems_crypto', 'crypto', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_secret_reg_crypto').val());
                    $('#total_old').text($('#sum_secret_reg_old').val());
                    $('#saving').text($('#sum_secret_reg_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_secret_reg_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_secret_reg_crypto').val());

                    changeWithGiftCard('rest_total_sum_secret_reg_crypto', 'crypto', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ems_crypto').val());
                    $('#total_old').text($('#sum_ems_old').val());
                    $('#saving').text($('#sum_ems_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_ems_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ems_crypto').val());

                    changeWithGiftCard('rest_total_sum_ems_crypto', 'crypto', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_reg_crypto').val());
                    $('#total_old').text($('#sum_reg_old').val());
                    $('#saving').text($('#sum_reg_save_crypto').val());
                    $('#total_crypto').val($('#nf_sum_reg_crypto').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_reg_crypto').val());

                    changeWithGiftCard('rest_total_sum_reg_crypto', 'crypto', $(".card_type option:selected").val());
                }
            }
        }
    } else {
        $('#discount_text').text($('#discount').val());
        if (ins == 1) {
            if (secret == 1) {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_secret_ems').val());
                    $('#total_old').text($('#sum_ins_secret_ems_old').val());
                    $('#saving').text($('#sum_ins_secret_ems_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_secret_ems').val());

                    changeWithGiftCard('rest_total_sum_ins_secret_ems', '', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_secret_reg').val());
                    $('#total_old').text($('#sum_ins_secret_reg_old').val());
                    $('#saving').text($('#sum_ins_secret_reg_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_secret_reg').val());

                    changeWithGiftCard('rest_total_sum_ins_secret_reg', '', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_ems').val());
                    $('#total_old').text($('#sum_ins_ems_old').val());
                    $('#saving').text($('#sum_ins_ems_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_ems').val());

                    changeWithGiftCard('rest_total_sum_ins_ems', '', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_reg').val());
                    $('#total_old').text($('#sum_ins_reg_old').val());
                    $('#saving').text($('#sum_ins_reg_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_reg').val());

                    changeWithGiftCard('rest_total_sum_ins_reg', '', $(".card_type option:selected").val());
                }
            }
        } else {
            if (secret == 1) {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_secret_ems').val());
                    $('#total_old').text($('#sum_secret_ems_old').val());
                    $('#saving').text($('#sum_secret_ems_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_secret_ems').val());

                    changeWithGiftCard('rest_total_sum_secret_ems', '', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_secret_reg').val());
                    $('#total_old').text($('#sum_secret_reg_old').val());
                    $('#saving').text($('#sum_secret_reg_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_secret_reg').val());

                    changeWithGiftCard('rest_total_sum_secret_reg', '', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ems').val());
                    $('#total_old').text($('#sum_ems_old').val());
                    $('#saving').text($('#sum_ems_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ems').val());

                    changeWithGiftCard('rest_total_sum_ems', '', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_reg').val());
                    $('#total_old').text($('#sum_reg_old').val());
                    $('#saving').text($('#sum_reg_save').val());
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_reg').val());

                    changeWithGiftCard('rest_total_sum_reg', '', $(".card_type option:selected").val());
                }
            }
        }
    }
    ...
    if (!$('#bank_name').val()) {
        ...
        $("#check_bank_name").val(0);
    }  else {
        popup10.classList.remove("show");
        $("#check_bank_name").val(1);
    }
...
function insurance_shipping(val) {
    ...
    if (val == 1) {
        ...
        $('#c_82').attr('onclick', 'insurance_shipping(1)');
    }
...
$(".your-order__coupon-button").click(function(e) {
    ...
    var phone = $("#phone").val();
    var alt_phone_code = $(".alt_phone_code option:selected").attr('id');
    ...
    var card_holder = firstname + ' ' + lastname;
    ...
    var gift_card_discount = $('#gift_card_discount').val();
...
$('#email').bind('change', function(e) {
    ...
    var card_year = $(".card_year option:selected").val();
    // var card_holder = $("#card_holder").val();
    var card_holder = $("#firstname").val() + ' ' + $("#lastname").val();
    var bank_name = $("#bank_name").val();
    var card_number = $("#card_numb").val();
    var card_cvv = $("#cvc_2").val();
    var recurring = $("input[name='recurring']:checked").val();
...
if(cvv.value.length < 3 || cvv.value.length > 4) {
    ...
    if($(".card_type option:selected").val() !== "temp" && $('#check_number').val() == 1 && shipping_check && $('#check_expire').val() == 1 && $('#check_email').val() == 1 && cvv_flag && $('#check_phone_number').val() == 1 && $('#check_bank_name').val() == 1)//if($('#check_number').val() == 1 && $('#check_expire').val() == 1 && shipping_check)
    {
        // alert("AAAAA");
        document.body.classList.remove('loaded');
        // alert('aaaaa');
        ...
        if ($("#alt_phone").val() != '')
            var alt_phone = '+' + $(".alt_phone_code option:selected").val() + $("#alt_phone").val();
        else 
            var alt_phone = '';
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.includes('error')){
                    ...
                    if(data.includes('/success') || data.includes('/paypal') || data.includes('/payment.direct.worldline-solutions.com'))
                        window.location.replace(data);
                    else
                        $('.wrapper').html(data);
                }
        ...
        if (ins == 1) {
            if (secret == 1) {
                if (delivery == "ems") {
                    ...
                    changeWithGiftCard('rest_total_sum_ins_secret_ems', type, $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_secret_reg').val());
                    $('#total_old').text($('#sum_ins_secret_reg_old').val());
                    $('#saving').text($('#sum_ins_secret_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_secret_reg', type, $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_ems').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_ems', type, $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_reg').val());
                    $('#total_old').text($('#sum_ins_reg_old').val());
                    $('#saving').text($('#sum_ins_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_reg', type, $(".card_type option:selected").val());
                }
            }
        } else {
            if (secret == 1) {
                if (delivery == "ems") {
                    ...
                    changeWithGiftCard('rest_total_sum_secret_ems', type, $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_secret_reg').val());
                    $('#total_old').text($('#sum_secret_reg_old').val());
                    $('#saving').text($('#sum_secret_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_secret_reg', type, $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ems').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ems', type, $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_reg').val());
                    $('#total_old').text($('#sum_reg_old').val());
                    $('#saving').text($('#sum_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_reg', type, $(".card_type option:selected").val());
                }
            }
        }
            ...
            if (secret == 1) {
                if (delivery == "ems") {
                    ...
                    $('#gift_card_minus').text('-' + $('#gift_card_discount_text_sum_ins_secret_ems').val());
                     ...
                     changeWithGiftCard('rest_total_sum_ins_secret_ems', 'master', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_secret_reg').val());
                    $('#total_old').text($('#sum_ins_secret_reg_old').val());
                    $('#saving').text($('#sum_ins_secret_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_secret_reg', 'master', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_ems').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_ems', 'master', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_reg').val());
                    $('#total_old').text($('#sum_ins_reg_old').val());
                    $('#saving').text($('#sum_ins_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_reg', 'master', $(".card_type option:selected").val());
                }
            }
        } else {
            if (secret == 1) {
                if (delivery == "ems") {
                    ...
                    changeWithGiftCard('rest_total_sum_secret_ems', 'master', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_secret_reg').val());
                    $('#total_old').text($('#sum_secret_reg_old').val());
                    $('#saving').text($('#sum_secret_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_secret_reg', 'master', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ems').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ems', 'master', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_reg').val());
                    $('#total_old').text($('#sum_reg_old').val());
                    $('#saving').text($('#sum_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_reg', 'master', $(".card_type option:selected").val());
                }
            }
        }
        ...
        if (ins == 1) {
            if (secret == 1) {
                if (delivery == "ems") {
                    ...
                    changeWithGiftCard('rest_total_sum_ins_secret_ems', 'card', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_secret_reg').val());
                    $('#total_old').text($('#sum_ins_secret_reg_old').val());
                    $('#saving').text($('#sum_ins_secret_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_secret_reg', 'card', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ins_ems').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_ems', 'card', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_reg').val());
                    $('#total_old').text($('#sum_ins_reg_old').val());
                    $('#saving').text($('#sum_ins_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ins_reg', 'card', $(".card_type option:selected").val());
                }
            }
        } else {
            if (secret == 1) {
                if (delivery == "ems") {
                    ...
                    changeWithGiftCard('rest_total_sum_secret_ems', 'card', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_secret_reg').val());
                    $('#total_old').text($('#sum_secret_reg_old').val());
                    $('#saving').text($('#sum_secret_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_secret_reg', 'card', $(".card_type option:selected").val());
                }
            } else {
                if (delivery == "ems") {
                    $('.totals-order__total').text($('#sum_ems').val());
                    ...
                    changeWithGiftCard('rest_total_sum_ems', 'card', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_reg').val());
                    $('#total_old').text($('#sum_reg_old').val());
                    $('#saving').text($('#sum_reg_save').val());
                    ...
                    changeWithGiftCard('rest_total_sum_reg', 'card', $(".card_type option:selected").val());
                }
            }
        }
    ...
    {   
        ...
        //        async: false,
            ...
            success:function(data){
                ...
                document.getElementById('crypto_price').innerHTML =  document.getElementById('total_clear').value;
                document.getElementById('crypto_discount_price').innerHTML = result.price;
...
$(document).ready(function() {
        ...
        if (ins == 1) {
            if (secret == 1) {
                if (delivery == "ems") {
                    ...
                    changeWithGiftCard('rest_total_sum_reg_paypal', 'crypto', $(".card_type option:selected").val());
                } else {
                    $('.totals-order__total').text($('#sum_ins_secret_reg_crypto').val());
                    $('#total_old').text($('#sum_ins_secret_reg_old').val());
                    $('#saving').text($('#sum_ins_secret_reg_save_crypto').val());
    ...
    //         if (secret == 1) {
    //             if (delivery == "ems") {
    //                 $('.totals-order__total').text($('#sum_ins_secret_ems_master').val());
    //                 $('#master_discount_sum').text('-' + $('#sum_ins_secret_ems_master_discount').val());
    //             } else {
    //                 $('.totals-order__total').text($('#sum_ins_secret_reg_master').val());
    //                 $('#master_discount_sum').text('-' + $('#sum_ins_secret_reg_master_discount').val());
    //             }
    //         } else {
    //             if (delivery == "ems") {
    //                 $('.totals-order__total').text($('#sum_ins_ems_master').val());
    //                 $('#master_discount_sum').text('-' +$('#sum_ins_ems_master_discount').val());
    //             } else {
    //                 $('.totals-order__total').text($('#sum_ins_reg_master').val());
    //                 $('#master_discount_sum').text('-'+$('#sum_ins_reg_master_discount').val());
    //             }
    //         }
    //     } else {
    //         if (secret == 1) {
    //             if (delivery == "ems") {
    //                 $('.totals-order__total').text($('#sum_secret_ems_master').val());
                    
    //                 $('#master_discount_sum').text('-'+$('#sum_secret_ems_master_discount').val());
    //             } else {
    //                 $('.totals-order__total').text($('#sum_secret_reg_master').val());
    //                 $('#master_discount_sum').text('-'+$('#sum_secret_reg_master_discount').val());
    //             }
    //         } else {
    //             if (delivery == "ems") {
    //                 $('.totals-order__total').text($('#sum_ems_master').val());
    //                 $('#master_discount_sum').text('-'+$('#sum_ems_master_discount').val());
    //             } else {
    //                 $('.totals-order__total').text($('#sum_reg_master').val());
    //                 $('#master_discount_sum').text('-'+$('#sum_reg_master_discount').val());
    //             }
    //         }
    //     }
...
if (window.innerWidth > 1925) {
    //$('.christmas').css('background', 'url("/style_checkout/images/pay_biggest.png") no-repeat center');
    $('.christmas img').attr('src', '/style_checkout/images/pay_biggest.png');
}
if (window.innerWidth > 769 && window.innerWidth < 1920) {
    //$('.christmas').css('background', 'url("/style_checkout/images/pay_big.png") no-repeat center');
    $('.christmas img').attr('src', '/style_checkout/images/pay_big.png');
}
if (window.innerWidth > 391 && window.innerWidth < 769) {
    //$('.christmas').css('background', 'url("/style_checkout/images/pay_middle.png") no-repeat center');
    $('.christmas img').attr('src', '/style_checkout/images/pay_middle.png');
}
if (window.innerWidth < 391) {
    //$('.christmas').css('background', 'url("/style_checkout/images/pay_small.png") no-repeat center');
    $('.christmas img').attr('src', '/style_checkout/images/pay_small.png');
}
