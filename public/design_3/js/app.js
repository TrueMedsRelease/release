...
(() => {
    ...
    function tabs() {
        ...
        function initTabs(tabsBlock) {
            const firstTitle = document.querySelector(".bestsellers__title");
            if (window.innerWidth > 700) firstTitle.classList.add("_tab-active");
            let tabsTitles = tabsBlock.querySelectorAll("[data-tabs-titles]>*");
            let tabsContent = tabsBlock.querySelectorAll("[data-tabs-body]>*");
            const tabsBlockIndex = tabsBlock.dataset.tabsIndex;
            const tabsActiveHashBlock = tabsActiveHash[0] == tabsBlockIndex;
            // console.log(tabsBlockIndex, tabsActiveHash[0], tabsActiveHashBlock);
    ...
    if (announces.length > 0) {
        ...
        for (let index = 0; index < announces.length; index++) {
            const announce = announces[index];
            setInterval((() => {
    ...
    if (window.innerWidth < 1024) {
        ...
        $(document).on('click', '.phones-header', function () {
            $(this).toggleClass('active');
        });
    }
...
//
//     if (window.innerWidth > 1925) {
//         $('.christmas').css('background', 'url("' + $('#path_image').val() + '/pay_biggest.png") no-repeat center')
//     }
//     if (window.innerWidth > 769 && window.innerWidth < 1920) {
//         $('.christmas').css('background', 'url("' + $('#path_image').val() + '/pay_big.png") no-repeat center')
//     }
//     if (window.innerWidth > 391 && window.innerWidth < 769) {
//         $('.christmas').css('background', 'url("' + $('#path_image').val() + '/pay_middle.png") no-repeat center')
//     }
//     if (window.innerWidth < 391) {
//         $('.christmas').css('background', 'url("' + $('#path_image').val() + '/pay_small.png") no-repeat center')
//     }
// });
//
...
//     const name = document.getElementById("name").value;
//     const email = document.getElementById("jabber").value;
//     const message = document.getElementById("message").value;
//     const captcha = document.getElementById("captcha").value;
//     const submit = true;
//     $.ajax({
...
function sendAjaxContact() {
    ...
    if (name.length === 0) {
        ...
        document.getElementById("name").style.backgroundColor = "#f1f5f9";
    }
    const email = document.getElementById("email").value;
