...
function sendAjaxContact() {
    ...
    if (name.length === 0) {
        ...
        document.getElementById("contact-name").style.borderColor = "#ebebeb";
    }
    ...
    if (!email.match(validRegex) || email.length === 0) {
        ...
        document.getElementById("contact-email").style.borderColor = "#ebebeb";
    }
...
function sendAjaxAffiliate() {
    ...
    if (name.length === 0) {
        ...
        document.getElementById("affiliate-name").style.borderColor = "#ebebeb";
    }
    ...
    if (!email.match(validRegex) || email.length === 0) {
        ...
        document.getElementById("affiliate-email").style.borderColor = "#ebebeb";
    }
