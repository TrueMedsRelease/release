...
class Dialog extends _BaseComponent__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  constructor(rootElement) {
    ...
    this.dialog = this.rootElement.querySelector('.dialog');
    this.backdropFilterResizeObserver = null;
  ...
  updateUI() {
    ...
    if (isOpen) {
      ...
      if (Dialog.stackable) {
        ...
        const backdropFilter = Dialog.overlay.querySelector('.overlay__filter');
        backdropFilter.style.setProperty('width', this.dialog.clientWidth + 'px');
        backdropFilter.style.setProperty('height', this.dialog.clientHeight + 'px');
        Dialog.overlay.classList.add(isVisible);
        Dialog.openModals.length === 2 && Dialog.openModals[0].close();

        // Resize observer on dialog to update filter size
        this.backdropFilterResizeObserver = new ResizeObserver((entries) => {
          backdropFilter.style.setProperty('width', entries[0].target.clientWidth + 'px');
          backdropFilter.style.setProperty('height', entries[0].target.clientHeight + 'px');
        });
        this.backdropFilterResizeObserver.observe(this.dialog);
      }
      ...
      this.backdropFilterResizeObserver.disconnect();
    }
  }
  ...
  createOverlay() {
    if (!Dialog.overlay) {
      Dialog.overlay = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.createOverlay)('dialog-overlay', document.body, true);
    }
  }
...
class Sticky extends _BaseComponent__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  toggleStickState() {
    const mqMedium = window.matchMedia('(min-width: 829.98px)');
    if (mqMedium.matches) return;
...
function initCategoriesNav() {
  ...
  const catCloseButtons = catNav.querySelectorAll('[data-cat-nav-close]');
  ...
  catCloseButtons.forEach((button) => {
    button.addEventListener('click', () => {
      closeCatNav();
    });
  });
  ...
  window.addEventListener('click', (e) => {
    if (!catNav.contains(e.target) && e.target.closest('[data-cat-nav-opener]') === null) {
      closeCatNav();
    }
  });
...
function createOverlay(className, parent = document.body, filter = false) {
  const overlay = document.createElement('div');
  if (filter) {
    const filter = document.createElement('div');
    filter.classList.add('overlay__filter');
...
/* harmony import */ var _components_Sticky__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Sticky */ "./js/components/Sticky.js");
...
/* harmony import */ var _components_Dialog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/Dialog */ "./js/components/Dialog.js");
/* harmony import */ var _components_Drawer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Drawer */ "./js/components/Drawer.js");
/* harmony import */ var _components_Dropdown__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Dropdown */ "./js/components/Dropdown.js");
/* harmony import */ var _components_greedy_nav__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/greedy-nav */ "./js/components/greedy-nav.js");
/* harmony import */ var _components_drag_nav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/drag-nav */ "./js/components/drag-nav.js");
...
/* harmony import */ var _components_categories_nav__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/categories-nav */ "./js/components/categories-nav.js");
/**
...
new _components_Sticky__WEBPACK_IMPORTED_MODULE_1__["default"]();
new _components_Accordion__WEBPACK_IMPORTED_MODULE_2__["default"]();
new _components_Dialog__WEBPACK_IMPORTED_MODULE_3__["default"]();
new _components_Drawer__WEBPACK_IMPORTED_MODULE_4__["default"]();
new _components_Dropdown__WEBPACK_IMPORTED_MODULE_5__["default"]();
const greedyNav = new _components_greedy_nav__WEBPACK_IMPORTED_MODULE_6__["default"]('.greedy-nav');
const dragNav = new _components_drag_nav__WEBPACK_IMPORTED_MODULE_7__["default"]('.drag-nav');
...
(0,_components_categories_nav__WEBPACK_IMPORTED_MODULE_11__.initCategoriesNav)();
