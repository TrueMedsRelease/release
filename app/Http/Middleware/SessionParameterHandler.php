...
class SessionParameterHandler
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $on7Pills = Str::is(['7-pills.com', '*.7-pills.com', '7-pills.net', '*.7-pills.net', '7-pill.com', '*.7-pill.com', '77-pills.com', '*.77-pills.com', '7-pillz.com', '*.7-pillz.com'], $request->getHost());
