...
class CheckoutController extends Controller
{
    ...
    public function send_google(Request $request)
    {
        ...
        $data = [
            ...
            'language' => App::currentLocale(),
            'currency' => session('currency'),
            'user_agent' => 'user_agent=' . $request->userAgent() . '&lang=' . request()->header('Accept-Language') . '&screen_resolution=' . $form['screen_resolution'] . '&customer_date=' . $request->customer_date,
            'fingerprint' => '',
            'product_total' => session('total.product_total'),
            'customer_id' => '',
            'reorder' => 0,
