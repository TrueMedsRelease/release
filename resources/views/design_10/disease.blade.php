            ...
            @foreach ($products as $product)
                <article class="card product-card">
                    ...
                    <a class="product-card__img" href="{{ route('home.product', $product['url']) }}">
                        ...
                        @endif
                        {{-- <img loading="lazy" src="{{ $product['image'] != "gift-card" ? asset("images/" . $product['image'] . ".webp") : asset($design . '/images/products/gift-card.svg') }}" width="140" height="140" alt="{{ $product['name'] }}"> --}}
                    </a>
