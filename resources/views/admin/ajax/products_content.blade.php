                            ...
                            @foreach ($Language::GetAllLanuages() as $item)
                                <div class="products__enters">
                                    ...
                                    <div class="input_elem">
                                        <input class="input" type="text" id="{{ $item['id'] }}_name_field" name="{{ $item['id'] }}_name_field" value="{{ $product_info->names[$item['id']] }}" size="32" maxlength="64"/>
                                    </div>
                        ...
                        <fieldset>
                            ...
                            @foreach ($Language::GetAllLanuages() as $item)
                                <div style="margin: 15px 0">
                                    <div class="label" style='text-align: left;font-weight: bold;margin-left: 5%; width:100%;'>{{ $item['name'] }}</div>
                                    <div class="products__enters">
                        ...
                        <fieldset>
                            ...
                            <div id="product_prices" style="display:flex; flex-direction:column;">
                                @foreach ($product_info->packaging_info as $pack_id => $packaging_info)
                                    <div style="margin: 15px 0;">
                                        <div class="rowElem">
                                            <div class="label" style="text-align: left;font-weight: bold;margin-left: 5%; width: 100%;">
                                                <h4>{{ $pack_id }}</h4>
                                            </div>
                                        </div>
                                        @foreach ($packaging_info as $pack)
                                            <div class="rowElem" style="padding-top:1%; display:flex; align-items:center;">
                                                ...
                                                <div class="label" style="width: 30%; float: right; text-align:center;">
                    ...
                    <td valign="middle" width="60%" align="center">
                        ...
                        <fieldset>
                            ...
                            <div class="products__enters" style="flex-direction: row;padding-top: 1.2%; padding-bottom: 7.6%;">
                                <div class="label">{{__('text.admin_products_product_manufacturer_title')}}</div>
                                <div class="input_elem">
                                    <textarea class="input" id="sinonims_field" name="sinonims_field" cols="40" rows="4"></textarea>
                                </div>
                                <div id="sinonims_error"></div>
                            </div>
                        </fieldset>
