					...
					<div class="bonus-line__inner">
						<div class="bonus-line__items">
                            <div class="bonus-line__item">
                                <div class="checkbox">
                                    <input data-bonus  id="pack-0" class="checkbox__input" type="radio" name="bonus" value="0" @checked(session('cart_option.bonus_id', 0) == 0)
                            ...
                            @foreach ($bonus as $product)
                                <div class="bonus-line__item">
                                    <div class="checkbox">
                                        <input data-bonus  id="pack-{{ $loop->iteration + 1 }}" class="checkbox__input" type="radio" name="bonus" value="{{ $product->pack_id }}" @checked(session('cart_option.bonus_id', 0) == $product->pack_id)
