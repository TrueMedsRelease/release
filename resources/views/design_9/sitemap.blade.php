            ...
            <div class="default__body">
                <div class="default__content">
                    ...
                    <div style="margin-bottom: 20px">
                        <div style="font-size: 2rem; margin-bottom: 20px;">{{ __('text.sitemap_site_info') }}:</div>
                    ...
                    <div style="margin-bottom: 20px">
                        <div style="font-size: 2rem; margin-bottom: 20px;">{{ __('text.category_title') }}:</div>
                    ...
                    <div style="margin-bottom: 20px">
                        <div style="font-size: 2rem; margin-bottom: 20px;">{{ __('text.sitemap_language_title') }}:</div>
                        <div class="site_info_url_block" style="margin-left: 20px">
