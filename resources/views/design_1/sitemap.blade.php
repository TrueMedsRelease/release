...
<section class="page__text-block text-block">
    <div class="text-block__container">
        <h2 class="text-block__title title" id = "scroll">{{__('text.menu_title_sitemap')}}</h2>
        <div style="margin-bottom: 20px; line-height: 25px;">
            <div style="font-size: 25px; margin-bottom: 20px;">{{ __('text.sitemap_site_info') }}:</div>
        ...
        <div style="margin-bottom: 20px">
            <div style="font-size: 25px; margin-bottom: 20px;">{{ __('text.category_title') }}:</div>
            <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 20px;">
                <div style="margin-left: 20px; line-height: 25px;">
                    <div>
                        <div class="site_info_url_item" >
                            <a class="site_info_link" href="{{ route('home.index') }}" style="font-size: 20px">
                ...
                @foreach ($menu as $category)
                    <div style="margin-left: 20px; line-height: 25px;">
                        <div>
                            <div class="site_info_url_item">
                                <a class="site_info_link" href="{{ route('home.category', $category['url']) }}" style="font-size: 20px">
                                    {{ $category['name'] }}
                                </a>
                            </div>
                        </div>
        ...
        <div style="margin-bottom: 20px; line-height: 25px;">
            <div style="font-size: 25px; margin-bottom: 20px;">{{ __('text.sitemap_language_title') }}:</div>
            <div class="site_info_url_block" style="margin-left: 20px">
