...
<html lang="en">
  <head>
    ...
    <link href="{{ asset($design . "/fonts/plus-jakarta-sans-regular.woff2") }}" rel="preload" as="font" type="font/woff2"
    ...
    <link href="{{ asset($design . "/fonts/plus-jakarta-sans-bold.woff2") }}" rel="preload" as="font" type="font/woff2" crossorigin="anonymous">
      ...
      <div class="container">
        <div class="header__grid-wrapper"><!-- Phones-->
          <address class="header__phones">
            ...
            <ul class="header__phones-wrapper">
              <li class="dropdown-item"><a class="header-phone" href="tel:+17185503732">US: +1 718 550 3732</a></li>
              <li class="dropdown-item"><a class="header-phone" href="tel:+17185503732">UK: +1 718 550 3732</a></li>
              <li class="dropdown-item"><a class="header-phone" href="tel:+17185503732">AU: +1 718 550 3732</a></li>
              <li class="dropdown-item"><a class="header-phone" href="tel:+17185503732">DE: +1 718 550 3732</a></li>
              <li class="dropdown-item"><a class="header-phone" href="tel:+17185503732">AU: +1 718 550 3732</a></li>
              <li class="dropdown-item"><a class="header-phone" href="tel:+17185503732">UK: +1 718 550 3732</a></li>
              <li class="dropdown-item"><a class="header-phone" href="tel:+17185503732">AU: +1 718 550 3732</a></li>
            </ul>
            <div class="dropdown"><button class="dropdown__button" aria-label="Show dropdown"><span class="icon"><svg
          ...
          <div class="header__controls">
            <div class="header__lang header-select-wrapper">
                ...
                </select><span class="icon header-select-wrapper__icon"><svg width="1em" height="1em" fill="currentColor">
                  <use href="{{ $design }}/svg/icons/sprite.svg#world"></use>
                </svg></span><span class="icon header-select-wrapper__chevron"><svg width="1em" height="1em"
                  fill="currentColor">
            ...
            <div class="header__currency header-select-wrapper"><select class="header-select">
                ...
                <option value="5">CNY</option>
                  ...
                  fill="currentColor">
                  <use href="{{ $design }}/svg/icons/sprite.svg#chevron-down"></use>
                </svg></span></div><a class="header__auth" href="#!"><span class="icon"><svg width="1em" height="1em"
                  fill="currentColor">
                  <use href="{{ $design }}/svg/icons/sprite.svg#profile"></use>
                </svg></span> My account</a>
          </div><!-- Logo--><a class="logo" href="index.html">
            <div class="logo__image"><img src="{{ asset("$design/svg/logo.svg") }}" width="40" height="40" alt="Site logo"></div>
            <div class="logo__title">TrueMeds</div>
            <div class="logo__text">Discount Store. Since 1998</div>
          </a>
          <div class="header__search-wrapper"><!-- Categories button--><button class="button categories-button"><span
                class="icon"><svg width="1em" height="1em" fill="currentColor">
                  <use href="{{ asset("$design/svg/icons/sprite.svg") }}#hotdog"></use>
                </svg></span> <span class="button__text">Categories</span></button><!-- Search-->
            <form class="form search-form"><label class="form__label form__label--text"><input
                  class="form__text-input input-text" type="text"
                  placeholder="Enter a drug name or active ingredient..."></label><button class="search-button"
                aria-label="Search"><span class="icon"><svg width="1em" height="1em" fill="currentColor">
                    <use href="{{ asset("$design/svg/icons/sprite.svg") }}#search"></use>
                  </svg></span></button></form><!-- Cart--><a class="cart-button button button--secondary"
              href="cart.html" data-counter="3"><span class="icon"><svg width="1em" height="1em" fill="currentColor">
                  <use href="{{ asset("$design/svg/icons/sprite.svg") }}#cart"></use>
                </svg></span> <span class="button__text">Cart</span> <span class="button__total">$36.10</span></a>
          </div>
        </div><!-- Header info-->
        <div class="header__info">
          <div class="customer-choise">
            <div class="customer-choise__logo"><img src="{{ asset("$design/svg/ui/choise.svg") }}" width="42" height="42" alt="Site logo">
            </div>
            <div class="customer-choise__counter">1 000 000</div>
            <div class="customer-choise__text">customers have chosen our amazing service and high-quality products</div>
          </div>
          <div class="header-brands">
            <div class="header-brand">
              <picture>
                ...
                <source type="image/webp" srcset="{{  asset("$design/images/brands/brand-1-31w.webp") }} 1x,{{  asset("$design/images/brands/brand-1-63w.webp") }} 2x"><img
                  src="{{  asset("$design/images/brands/brand-1-31w.jpg") }}" srcset="{{  asset("$design/images/brands/brand-1-31w.jpg") }} 1x,{{  asset("$design/images/brands/brand-1-63w.jpg") }} 2x"
            ...
            <div class="header-brand">
              <picture>
                ...
                <source type="image/webp" srcset="{{ asset("$design/images/brands/brand-2-32w.webp") }} 1x,{{ asset("$design/images/brands/brand-2-65w.webp") }} 2x"><img
                  src="{{ asset("$design/images/brands/brand-2-32w.jpg") }}" srcset="{{ asset("$design/images/brands/brand-2-32w.jpg") }} 1x,{{ asset("$design/images/brands/brand-2-65w.jpg") }} 2x"
            ...
            <div class="header-brand">
              <picture>
                ...
                <source type="image/webp" srcset="{{ asset("$design/images/brands/brand-3-37w.webp") }} 1x,{{ asset("$design/images/brands/brand-3-75w.webp") }} 2x"><img
                  src="{{ asset("$design/images/brands/brand-3-37w.jpg") }}" srcset="{{ asset("$design/images/brands/brand-3-37w.jpg") }} 1x,{{ asset("$design/images/brands/brand-3-75w.jpg") }} 2x"
            ...
            <div class="header-brand">
              <picture>
                ...
                <source type="image/webp" srcset="{{ asset("$design/images/brands/brand-4-24w.webp") }} 1x,{{ asset("$design/images/brands/brand-4-49w.webp") }} 2x"><img
                  src="{{ asset("$design/images/brands/brand-4-24w.jpg") }}" srcset="{{ asset("$design/images/brands/brand-4-24w.jpg") }} 1x,{{ asset("$design/images/brands/brand-4-49w.jpg") }} 2x"
            ...
            <div class="header-brand">
              <picture>
                ...
                <source type="image/webp" srcset="{{ asset("$design/images/brands/brand-5-42w.webp") }} 1x,{{ asset("$design/images/brands/brand-5-85w.webp") }} 2x"><img
                  src="{{ asset("$design/images/brands/brand-5-42w.jpg") }}" srcset="{{ asset("$design/images/brands/brand-5-42w.jpg") }} 1x,{{ asset("$design/images/brands/brand-5-85w.jpg") }} 2x"
            ...
            <div class="header-brand">
              <picture>
                ...
                <source type="image/webp" srcset="{{ $design }}/images/brands/brand-6-55w.webp 1x,{{ $design }}/images/brands/brand-6-111w.webp 2x"><img
                  src="{{ asset("$design/images/brands/brand-6-55w.jpg") }}" srcset="{{ asset("$design/images/brands/brand-6-55w.jpg") }} 1x,{{ asset("$design/images/brands/brand-6-111w.jpg") }} 2x"
        ...
        <nav class="nav header-nav">
          <div class="nav-container">
            <ul class="nav__list">
              <li class="nav__item"><a class="nav__link is-active" href="{{ route('home.index') }}">Bestsellers</a></li>
              <li class="nav__item"><a class="nav__link" href="{{ route('home.about') }}">Abous US</a></li>
              <li class="nav__item"><a class="nav__link" href="{{ route('home.help') }}">Help</a></li>
              <li class="nav__item"><a class="nav__link" href="{{ route('home.testimonials') }}">Testimonials</a></li>
              <li class="nav__item"><a class="nav__link" href="{{ route('home.delivery') }}">Delivery</a></li>
              <li class="nav__item"><a class="nav__link" href="{{ route('home.moneyback') }}">Moneyback</a></li>
              <li class="nav__item"><a class="nav__link" href="contact.html">Contact us</a></li>
            </ul>
          </div><button class="greedy-button" aria-label="Show dropdown"><span class="icon"><svg width="1em"
        ...
        <nav class="nav cat-nav">
          <div class="nav-container">
            ...
            <ul class="nav__list">
                <li class="nav__item">
                    <a class="nav__link is-active nav__sublist-toggler" href="index.html" data-sublist-index="0">Bestsellers</a>
                </li>
                @foreach ($menu as $category)
                <li class="nav__item">
                    <a class="nav__link nav__sublist-toggler" href="#!" data-sublist-index="{{ $loop->iteration }}">{{ $category['name'] }}</a>
                </li>
                @endforeach
            </ul>
            <div class="categories-sublists">
                <ul class="nav__sublist sublist-4-col" data-sublist-index="0">
                    ...
                    @foreach ($bestsellers as $bestseller)
                        <li class="nav__item"><a class="nav__link" href="#!">{{ $bestseller['name'] }}</a></li>
                    @endforeach
                </ul>
                @foreach ($menu as $category)
                <ul class="nav__sublist sublist-4-col" data-sublist-index="{{ $loop->iteration }}">
                    ...
                    @foreach ($category['products'] as $item)
                        <li class="nav__item"><a class="nav__link" href="#!">{{ $item['name'] }}</a></li>
                    @endforeach
                </ul>
                @endforeach
            </div>
      ...
      <div class="drug-index">
        <div class="drug-index__container">
          <ul class="drug-index__list">
            ...
            <li class="drug-index__item"><a class="drug-index__link" href="/first_letter/{{ $l }}">{{ $l }}</a></li>
            @endforeach
          </ul>
        </div>
      </div><!-- Store info-->
                    ...
                    <ul class="aside-nav__list">
                        ...
                        <li class="aside-nav__item">
                            <a class="aside-nav__link" href="#!">
                                {{ $bestseller['name'] }} <span class="aside-nav__price">${{ $bestseller['price'] }}</span>
                            </a>
                        </li>
                        @endforeach
                    </ul>
                ...
                <div class="accordion-panel">
                  <div class="accordion-content">
                    <ul class="aside-nav__list">
                        ...
                        <li class="aside-nav__item">
                            <a class="aside-nav__link" href="#!">
                                {{ $item['name'] }}<span class="aside-nav__price">${{ $item['price'] }}</span>
                            </a>
                        </li>
                        @endforeach
                    </ul>
      ...
      <div class="subscribe">
        ...
        <form class="form form form--secondary subscribe-form">
          <div class="form__field"><label class="form__label form__label--email"><input
                class="form__text-input input-email" type="email" placeholder="Email" required></label></div>
    ...
    <footer class="footer">
      <div class="container">
        <div class="footer__wrapper"><!-- Footer logo--><a class="logo logo--footer" href="index.html">
            <div class="logo__image"><img src="{{ $design }}/svg/logo-footer.svg" width="40" height="40" alt="Site logo"></div>
            <div class="logo__title">TrueMeds</div>
            <div class="logo__text">Discount Store. Since 1998</div>
          </a>
        ...
        <div class="footer__copyrights"><span>© 1999-2022 All rights reserved.</span><span>TrueMeds or its affiliates
            Licensed by the Pharmaceutical Association IPS License #25302</span></div><!-- Footer controls-->
        <div class="footer-buttons">
          <div class="footer-buttons__container"><a class="footer-button" href="index.html"><span class="icon"><svg
                  width="1em" height="1em" fill="currentColor">
                  <use href="{{ $design }}/svg/icons/sprite.svg#home"></use>
                </svg></span> <span class="button__text">Home</span></a><button
              class="footer-button footer-button--cat"><span class="icon"><svg width="1em" height="1em"
                  fill="currentColor">
                  <use href="{{ $design }}/svg/icons/sprite.svg#hotdog"></use>
                </svg></span> <span class="button__text">Categories</span></button><a class="footer-button"
              href="#!"><span class="icon"><svg width="1em" height="1em" fill="currentColor">
                  <use href="{{ $design }}/svg/icons/sprite.svg#profile"></use>
                </svg></span> <span class="button__text">My account</span></a><a
              class="footer-button footer-button--cart" href="cart.html" data-counter="2"><span class="icon"><svg
                  width="1em" height="1em" fill="currentColor">
    ...
    <dialog class="dialog" data-name="call" data-modal="true" data-clickable-backdrop="true">
      <div class="dialog__inner-wrapper">
        ...
        <form class="form callback-form" method="dialog">
          <div class="form__field"><input class="form__text-input input-tel intl-phone" type="tel" id="callback-phone"
              required><label class="form__label form__label--tel" for="callback-phone">Mobile phone:</label></div>
          <div class="form__field"><input class="button form__submit" type="submit" value="Request a call"></div>
        </form>
      </div>
    </dialog>
    <dialog class="dialog" data-name="call-push" data-modal="true" data-clickable-backdrop="true">
      <div class="dialog__inner-wrapper">
        <header class="dialog__header">
          ...
          <div class="dialog__note">Allow the site mysite.com send you a notification to your desktop</div><button
            class="dialog__close-button close-button">Close</button>
        </header>
        <form class="form callback-push-form" method="dialog">
          ...
          <div class="form__field callback-push-submit"><button class="button button--outline"
              type="button">Decline</button><button class="button form__submit" type="submit">Allow</button></div>
        </form>
      </div>
    </dialog>
  </body>
