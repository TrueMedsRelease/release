...
<div class="main">
    ...
    @if (count($products) == 0)
        ...
        @if (in_array(session('aff'), [1799, 1947, 1952, 1957]) || in_array(env('APP_AFF'), [1799, 1947, 1952, 1957]))
            ...
            @endphp
            <div class="button" id="go_to_contact_us" style="width: 100%; max-width: 300px; min-width: 270px; margin-bottom: 20px" onclick="location.href = '{{ route('home.contact_us', '_' . $domainWithoutZone) }}'">
        ...
        <section class="page__best-sellers best-sellers" >
            ...
            <div class="best-sellers__items">
                <a href="{{ route('home.bonus_referral_program') }}" class="product-card bonus_programm">
                    <div class="bonus_top">
