var land_prod = '<style type="text/css">
    @charset "UTF-8";
    ...
    @font-face {
        font-family: arialmt;
        font-display: swap;
        src: url("/{{ $design }}/fonts/arialmt.woff2") format("woff2"), url("/{{ $design }}/fonts/arialmt.woff") format("woff");
        font-weight: 400;
        font-style: normal;
    }
    ...
    @font-face {
        ...
        font-display: swap;
        src: url("/{{ $design }}/fonts/Helvetica-Bold.woff2") format("woff2"), url("/{{ $design }}/fonts/Helvetica-Bold.woff") format("woff");
        font-weight: 700;
        font-style: normal;
    }
    ...
    @font-face {
        font-family: Helvetica;
        font-display: swap;
        src: url("/{{ $design }}/fonts/Helvetica.woff2") format("woff2"), url("/{{ $design }}/fonts/Helvetica.woff") format("woff");
        font-weight: 400;
        font-style: normal;
    }
    ...
    *:after {
    ...
    .btn-up::before {
        ...
        background-image: url("/{{ $design }}/images/w_up_.webp");
    }
    ...
    .ac_loading {
        background: url("/{{ $design }}/images/autocomplete/search_process.gif") right center no-repeat;
    }
    ...
    .no-webp .select__value:after {
        background: url("/{{ $design }}/images/icons/arr-down.png") 0 0/contain no-repeat;
    }
    ...
    .visible::before {
        ...
        width: 14px;
        height: 14px;
        background: url("/{{ $design }}/images/icons/checkmark.svg") 0 0 no-repeat;
    ...
    .no-webp .advantages__accent::before {
        background-image: url("/{{ $design }}/images/advantages/stars.png");
    }
    ...
    .no-webp .advantages__item--save::before {
        background-image: url("/{{ $design }}/images/advantages/icons/save.png");
    }

    .no-webp .advantages__item--fast::before {
        background-image: url("/{{ $design }}/images/advantages/icons/fast.png");
    }

    .no-webp .advantages__item--prescription::before {
        background-image: url("/{{ $design }}/images/advantages/icons/prescription.png");
    }

    .no-webp .advantages__item--money::before {
        background-image: url("/{{ $design }}/images/advantages/icons/money.png");
    }
    ...
    .no-webp .cart::before {
        background-image: url("/{{ $design }}/images/icons/cart.png");
    }
    ...
    .no-webp .header__select::before {
        background-image: url("/{{ $design }}/images/icons/arrow.png");
    }
    ...
    .no-webp .search-form__button::before {
        background-image: url("/{{ $design }}/images/icons/search.png");
    }
    ...
    .no-webp .product-table__list--badge .product-table__package::before {
        background-image: url("/{{ $design }}/images/icons/discount.png");
        display: block;
    }
    ...
    .no-webp .product-table__cart::before {
        background-image: url("/{{ $design }}/images/icons/cart-white.png");
    }
    ...
    .no-webp .product-table__btn::before {
        background-image: url("/{{ $design }}/images/icons/cart.png") !important;
    }
    ...
    .no-webp .basket-benefits__item--discount::before {
        background-image: url("/{{ $design }}/images/icons/benefits/discount.png");
    }

    .no-webp .basket-benefits__item--regular::before {
        background-image: url("/{{ $design }}/images/icons/benefits/regular.png");
    }

    .no-webp .basket-benefits__item--express::before {
        background-image: url("/{{ $design }}/images/icons/benefits/express.png");
    }

    .no-webp .basket-benefits__item--secret::before {
        background-image: url("/{{ $design }}/images/icons/benefits/secret.png");
    }

    .no-webp .basket-benefits__item--moneyback::before {
        background-image: url("/{{ $design }}/images/icons/benefits/moneyback.png");
    }
    ...
    .no-webp .quantity__button::before {
        background-image: url("/{{ $design }}/images/icons/arrow-top.png");
    }
    ...
    .cmcmodal {
        ...
        right: 1%;
        padding: 20px;
        background: rgba(148, 245, 113, 0.7);
        box-sizing: border-box;
        border-radius: 15px;
        z-index: 9999;
    }
    ...
    .modal_cart {
        ...
        right: 1%;
        padding: 20px;
        background: rgba(247, 238, 79, 0.726);
        box-sizing: border-box;
        border-radius: 15px;
        z-index: 9999;
    }
    ...
    @media (min-width: 29.99875em) {
        ...
        /* .page__best-sellers { justify-content: flex-start; } */
        .sidebar-order {
    ...
    @media (min-width: 61.99875em) {
        ...
        /* .menu__body { position: fixed; width: 100%; height: 100%; top: 0; left: 0; overflow: auto; background-color: var(--white); padding: 5rem 1rem 1.5rem; opacity: 0; visibility: hidden; pointer-events: none; -webkit-transition: color 0.3s ease 0s, opacity 0.3s ease 0s, visibility 0.3s ease 0s; -o-transition: color 0.3s ease 0s, opacity 0.3s ease 0s, visibility 0.3s ease 0s; transition: color 0.3s ease 0s, opacity 0.3s ease 0s, visibility 0.3s ease 0s; z-index: 19; } .menu__body::before { content: ""; position: fixed; z-index: 20; width: 100%; height: 60px; left: 0; top: 0; background-color: var(--white); opacity: 0.85; } .menu-open .menu__body { opacity: 1; visibility: visible; pointer-events: auto; } .menu-open .menu__body::before { left: 0; } */
    ...
    .pay-index__container::-webkit-scrollbar,
    .ship-index__container::-webkit-scrollbar {
        width: 0;
        display: none;
    }
    ...
    .webp .select__value:after {
        background: url("/{{ $design }}/images/icons/arr-down.webp") 0 0/contain no-repeat;
    }

    .webp .advantages__accent::before {
        background-image: url("/{{ $design }}/images/advantages/stars.webp");
    }

    .webp .advantages__item--save::before {
        background-image: url("/{{ $design }}/images/advantages/icons/save.webp");
    }

    .webp .advantages__item--fast::before {
        background-image: url("/{{ $design }}/images/advantages/icons/fast.webp");
    }

    .webp .advantages__item--prescription::before {
        background-image: url("/{{ $design }}/images/advantages/icons/prescription.webp");
    }

    .webp .advantages__item--money::before {
        background-image: url("/{{ $design }}/images/advantages/icons/money.webp");
    }

    .webp .cart::before {
        background-image: url("/{{ $design }}/images/icons/cart.webp");
    }

    .webp .header__select::before {
        background-image: url("/{{ $design }}/images/icons/arrow.webp");
    }

    .webp .search-form__button::before {
        background-image: url("/{{ $design }}/images/icons/search.webp");
    }

    .webp .product-table__list--badge .product-table__package::before {
        background-image: url("/{{ $design }}/images/icons/discount.webp");
    }

    .webp .product-table__cart::before {
        background-image: url("/{{ $design }}/images/icons/cart-white.webp");
    }
    ...
    .webp .basket-benefits__item--discount::before {
        background-image: url("/{{ $design }}/images/icons/benefits/discount.webp");
    }

    .webp .basket-benefits__item--regular::before {
        background-image: url("/{{ $design }}/images/icons/benefits/regular.webp");
    }

    .webp .basket-benefits__item--express::before {
        background-image: url("/{{ $design }}/images/icons/benefits/express.webp");
    }

    .webp .basket-benefits__item--secret::before {
        background-image: url("/{{ $design }}/images/icons/benefits/secret.webp");
    }

    .webp .basket-benefits__item--moneyback::before {
        background-image: url("/{{ $design }}/images/icons/benefits/moneyback.webp");
    }

    .webp .quantity__button::before {
        background-image: url("/{{ $design }}/images/icons/arrow-top.webp");
    }
</style>
<div class="wrapper">
    <main class="page">
                ...
                <section class="product">
                    <div class="product__wrapper">
                        <div class="product-about">
                            <h2 class="product-about__title" id = "scroll"> {{ $product['name'] }} </h2>
                            <picture class="product_center">
                                @if ($product['image'] == 'gift-card')
                                    <img class="product-about__img"
                                        src="{{ asset($design . '/images/gift_card_img.svg') }}"
                                        alt="{{ $product['image'] }}">
                                @else
                                    <source srcset="{{ route('home.set_images', $product['image']) }}"
                                        type="image/webp"> <img class="product-about__img"
                                        src="{{ route('home.set_images', $product['image']) }}"
                                        alt="{{ $product['image'] }}">
                                    @endif
                            </picture>
                            <ul class="product-about__characteristics">
                                @if ($product['image'] != 'gift-card')
                                    @if (count($product['aktiv']) != 0)
                                        <li class="product-about__characteristic_"> <span
                                                class="product-about__characteristic-name"> {!! __('text.product_active') !!}
                                            </span>
                                            <ul>
                                                <li>
                                        ...
                                        </li> @endif <li class="product-about__characteristic_"> <span
                                                class="product-about__characteristic-name"> {!! __('text.product_pack1_1') !!}
                                            </span> <span class="product-about__characteristic-meaning"
                                                style="color: #f2d43a;">
                                                {{ __('text.product_pack2_1') }}{{ random_int(10, 40) }}{{ __('text.product_pack3_1') }}
                                            </span> </li> @endif <div class="product-about__text">
                                            <p> {{ $product['desc'] }} </p>
                                        </div>
                                        @if (count($product['disease']) > 0)
                                            <li class="product-about__characteristic"> <span
                                                    class="product-about__characteristic-name">
                                                    {{ __('text.product_diseases') }} </span>
                                                <ul>
                                                    <li>
                                            ...
                                            </li> @endif @if (!empty($product['analog']))
                                                <li class="product-about__characteristic"> <span
                                                        class="product-about__characteristic-name">
                                                        {{ $product['name'] }} {!! __('text.product_analogs') !!} </span>
                                                    <ul>
                                                        <li>
                                                            @foreach ($product['analog'] as $analog)
                                                                <a class="product-about__characteristic-meaning--link"
                                                                    href="{{ route('home.product', $analog['url']) }}">
                                                                    {{ $analog['name'] }} </a>
                                                                @endforeach
                                                        </li>
                                                    </ul>
                                                </li> @endif @if ($product['image'] != 'gift-card')
                                                    @if (!empty($product['sinonim']))
                                                        <li class="product-about__characteristic"> <span
                                                                class="product-about__characteristic-name">
                                                                {{ $product['name'] }} {!! __('text.product_others') !!} </span>
                                                            <ul>
                                                                <li>
                        ...
                        <div class="product__info">
                            @foreach ($product['packs'] as $key => $dosage)
                                <ul class="product__info-items"> @php $prev_dosage = 0; @endphp @foreach ($dosage as $item)
                                        @if ($loop->last)
                                            @continue
                                            @endif @if ($loop->iteration != 1 && $key != $prev_dosage)
                                                </tbody>
                                                </table>
                                                </li>
                                                    ...
                                                    <li class="product__info-item">
                                                        <h3 class="product__info-title">
                                                            @if (!in_array($product['id'], [616, 619, 620, 483, 484, 501, 615]))
                                                                {{ "{$product['name']} $key" }}@if ($loop->parent->iteration == 1 && $product['rec_name'] != 'none')
                                                                    <span style="font-weight:lighter;">,
                                                                        {{ __('text.product_need_more') }}</span> <a
                                                                        class="product-about__characteristic-meaning--link"
                                                                        href="{{ route('home.product', $product['rec_url']) }}">{{ $product['rec_name'] }}</a>
                                                                @endif
                                                            @else
                                                                {{ $product['name'] }}
                                                            @endif
                                                        ...
                                                        <table class="product-table">
                                                            <tbody>
                                                                <tr
                                                                    class="product-table__list product-table__list--top">
                                                                    <th class="product-table__package">
                                                                        {{ __('text.product_package_title') }}</th>
                                                                    <th class="product-table__per">
                                                                        {{ __('text.product_price_per_pill_title') }}
                                                                    </th>
                                                                    <th class="product-table__price">
                                                                        {{ __('text.product_price_title') }}</th>
                                                                    <th></th>
                                                                </tr> @php $prev_dosage = $key; @endphp
                                                                @endif <tr
                                                                    class="product-table__list @if ($loop->iteration == 1 && $product['image'] != 'gift-card') product-table__list--badge @endif">
                                                                    <th class="product-table__package">
                                                                        {{ "{$item['num']} {$product['type']}" }}
                                                                        @if ($product['image'] != 'gift-card')
                                                                            @if ($item['price'] >= 300)
                                                                                <span
                                                                                    class="product-table__prompt">{{ __('text.cart_free_express') }}</span>
                                                                            @elseif($item['price'] < 300 && $item['price'] >= 200)
                                                                                <span
                                                                                    class="product-table__prompt">{{ __('text.cart_free_regular') }}</span>
                                                                            @endif
                                                                            @endif </th>
                                                                    <th class="product-table__per">
                                                                    ...
                                                                    <th class="product-table__price">
                                                                        @if ($loop->remaining != 1 && $product['image'] != 'gift-card')
                                                                            <span
                                                                                class="product-table__old">{{ $Currency::convert($dosage['max_pill_price'] * $item['num'], true) }}</span>
                                                                            <span
                                                                                class="product-table__discount">-{{ ceil(100 - ($item['price'] / ($dosage['max_pill_price'] * $item['num'])) * 100) }}%</span>
                                                                            @endif @if ($product['image'] != 'gift-card')
                                                                                @if (ceil(100 - ($item['price'] / ($dosage['max_pill_price'] * $item['num'])) * 100) == 0)
                                                                                    <span
                                                                                        class="product-table__current--discount">{{ $Currency::convert($item['price'], true) }}</span>
                                                                                @else
                                                                                    <span
                                                                                        class="product-table__current">{{ __('text.cart_only') }}
                                                                                        {{ $Currency::convert($item['price'], true) }}</span>
                                                                                @endif
                                                                            @else
                                                                                <span
                                                                                    class="product-table__current">{{ $Currency::convert($item['price'], true) }}</span>
                                                                            @endif
                                                                    </th>
                                                                    <th class="product-table__add">
                                                                        <form
                                                                            ...
                                                                            method="post"> @csrf <button
                                                                                ...
                                                                                type="submit"> <span
                                                                                    class="sr-only">{{ __('text.product_add_to_cart_text') }}</span>
                                                                            </button> <button
                                                                                class="product-table__cart"
                                                                                type="submit">
