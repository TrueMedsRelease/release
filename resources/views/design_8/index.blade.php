    ...
    <div class="reclame">
        ...
        <div class="verified_block">
            <div class="verified_item_left">
                <img loading="lazy" src="{{ asset("$design/images/icons/img1.svg") }}" @if (in_array(session('aff'), [1799, 1947, 1952, 1957]) || in_array(env('APP_AFF'), [1799, 1947, 1952, 1957])) alt="{{ __('text.text_aff_domain_1') . ' ' . __('text.text_aff_domain_2') . ' verified pharmacy' }}" @else alt="" @endif>
            </div>
            <div class="verified_item_right">
                <img loading="lazy" src="{{ asset("$design/images/icons/companies.svg") }}" @if (in_array(session('aff'), [1799, 1947, 1952, 1957]) || in_array(env('APP_AFF'), [1799, 1947, 1952, 1957])) alt="{{ __('text.text_aff_domain_1') . ' ' . __('text.text_aff_domain_2') . ' partners' }}" @else alt="" @endif>
            </div>
        </div>
    ...
    <div class="block_middle">
        <div class="block_middle_left">
            ...
            <div class="text">
                ...
                <div class="list">
                    <img loading="lazy" src="{{ asset("$design/images/icons/tire.svg") }}">
        ...
        <div class="block_middle_right">
            <img loading="lazy" src="{{ asset("$design/images/pills.svg") }}">
        </div>
    </div>
                                        ...
                                        <div class="table_row">
                                            ...
                                            <form method="POST" action="{{ route('cart.add', $item['id']) }}">
                                                ...
                                                <button class="add_cart add" type="submit">
                                                    <img loading="lazy" src="{{ asset("$design/images/icons/cart.svg") }}" width="24" height="24">
