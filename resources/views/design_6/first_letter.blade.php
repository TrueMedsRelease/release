...
@section('title', __('text.first_letter_first_letter_result_title') . ' «' . $letter . '»')
...
<main class="page">
    <section class="page__products home-grid-items">
        ...
        <div class="home-grid-items__container">
            <h2 class="home-grid-items__title title">{{__('text.first_letter_first_letter_result_title')}}  «{{$letter}}»</h2>
