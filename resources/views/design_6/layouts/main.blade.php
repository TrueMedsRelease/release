        ...
        <header class="header">
            ...
            <div class="container header__container header__container--second">
                        ...
                        <button class="button-categories icon-menu" type="button">
                            ...
                            <div class="button-categories__arrow">
                                <svg width="20" height="20">
                                    <use xlink:href="{{ asset("$design/images/icons/icons.svg#svg-arr-down") }}">
                                    </use>
                                </svg>
                            </div>
                        </button>
                        ...
                        <nav class="menu__body">
                            <ul class="menu__list">
                                ...
                                <li class="menu__item"><a href="{{ route('home.about') }}"
                                        class="menu__link">{{ __('text.common_about_us_main_menu_item') }}</a></li>
                                <li class="menu__item"><a href="{{ route('home.help') }}"
                                        class="menu__link">{{ __('text.common_help_main_menu_item') }}</a></li>
                                <li class="menu__item" data-da=".menu__subslist, 900, first"><a
                                        href="{{ route('home.testimonials') }}"
                                        class="menu__link">{{ __('text.common_testimonials_main_menu_item') }}</a>
                                </li>
                                <li class="menu__item" data-da=".menu__subslist, 950, first"><a
                                        href="{{ route('home.delivery') }}"
                                        class="menu__link">{{ __('text.common_shipping_main_menu_item') }}</a></li>
                                <li class="menu__item" data-da=".menu__subslist, 1000, first"><a
                                        href="{{ route('home.moneyback') }}"
                                        class="menu__link">{{ __('text.common_moneyback_main_menu_item') }}</a></li>
                                <li class="menu__item" data-da=".menu__subslist, 1050, first"><a
                                        href="{{ route('home.contact_us') }}"
                                        class="menu__link">{{ __('text.common_contact_us_main_menu_item') }}</a></li>
                ...
                <div class="header__body">
                    <div class="header__right">
                            ...
                            <div class="header__inner">
                                <div class="header__top-row">
                                    <a href="{{ route('home.index') }}" class="header__logo logo">
                                        <img src="{{ asset("$design/images/logo.svg") }}" width="145"
                                            height="46" alt="">
                                    </a>
                                </div>
                                <div class="header__info-row">
                                    ...
                                    @endphp
                                    <button type="button" class="header__cart cart" data-da=".fixed-bar, 560, last"
                        ...
                        <div class="header__content">
                            <div class="header__verified verified-header">
                                <div class="verified-header__info">
                                    <div class="verified-header__icon">
                                        <svg width="40" height="40">
                                            <use
                                                xlink:href="{{ asset("$design/images/icons/icons.svg#svg-verified") }}">
                                            </use>
                                        </svg>
                                    </div>
                                ...
                                <div class="verified-header__partners partners-verified">
                                    <div class="partners-verified__item">
                                        <img src="{{ asset("$design/images/partners/fda.svg") }}" width="45"
                                            height="28">
                                    </div>
                                    <div class="partners-verified__item">
                                        <picture>
                                            <source srcset="{{ asset("$design/images/partners/pgeu.webp") }}"
                                                type="image/webp"><img
                                                src="{{ asset("$design/images/partners/pgeu.png") }}" width="39"
                                                height="32">
                                        </picture>
                                    </div>
                                    <div class="partners-verified__item">
                                        <picture>
                                            <source srcset="{{ asset("$design/images/partners/cipa.webp") }}"
                                                type="image/webp"><img
                                                src="{{ asset("$design/images/partners/cipa.png") }}" width="50"
                                                height="30">
                                        </picture>
                                    </div>
                                    <div class="partners-verified__item">
                                        <img src="{{ asset("$design/images/partners/mastercard.svg") }}"
                                            width="30" height="26">
                                    </div>
                                    <div class="partners-verified__item">
                                        <img src="{{ asset("$design/images/partners/visa.svg") }}" width="47"
                                            height="20">
                                    </div>
                                    <div class="partners-verified__item">
                                        <img src="{{ asset("$design/images/partners/mcafee.svg") }}" width="60"
                                            height="18">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="header__item-preference preference-header-item">
                                    <div class="preference-header-item__top">
                                        <div class="preference-header-item__icon">
                                            <svg width="40" height="40">
                                                <use
                                                    xlink:href="{{ asset("$design/images/icons/icons.svg#svg-preference-01") }}">
                                                </use>
                                            </svg>
                                        </div>
                                ...
                                <div class="header__item-preference preference-header-item">
                                    <div class="preference-header-item__top">
                                        <div class="preference-header-item__icon">
                                            <svg width="40" height="40">
                                                <use
                                                    xlink:href="{{ asset("$design/images/icons/icons.svg#svg-preference-02") }}">
                                                </use>
                                            </svg>
                                        </div>
                                        <h3 class="preference-header-item__title">{{ __('text.common_eco_product') }}
                                        </h3>
                                    </div>
                                ...
                                <div class="header__item-preference preference-header-item">
                                    <div class="preference-header-item__top">
                                        <div class="preference-header-item__icon">
                                            <svg width="40" height="40">
                                                <use
                                                    xlink:href="{{ asset("$design/images/icons/icons.svg#svg-preference-03") }}">
                                                </use>
                                            </svg>
                                        </div>
                                        <h3 class="preference-header-item__title">{{ __('text.common_delivery') }}
                                        </h3>
                                    </div>
                                ...
                                <div class="header__item-preference preference-header-item">
                                    <div class="preference-header-item__top">
                                        <div class="preference-header-item__icon">
                                            <svg width="40" height="40">
                                                <use
                                                    xlink:href="{{ asset("$design/images/icons/icons.svg#svg-preference-04") }}">
                                                </use>
                                            </svg>
                                        </div>
                                        <h3 class="preference-header-item__title">{{ __('text.common_moneyback') }}
                                        </h3>
                                    </div>
                            ...
                            <picture>
                                <source srcset="{{ asset("$design/images/decor/petal-4.webp") }}" type="image/webp">
                                <img class="header__decor-content"
                                    src="{{ asset("$design/images/decor/petal-4.png") }}" width="39"
                                    height="66">
                            </picture>
                        </div>
                    </div>
                    <div class="header__banner banner-header" data-da=".header__top, 479.98, last">
                        ...
                        <div class="banner-header__decor">
                            <picture>
                                <source srcset="{{ asset("$design/images/decor/petal-2.webp") }}" type="image/webp">
                                <img class="banner-header__petal-02"
                                    src="{{ asset("$design/images/decor/petal-2.png") }}" width="43"
                                    height="70">
                            </picture>
                            <picture>
                                <source srcset="{{ asset("$design/images/decor/petal-3.webp") }}" type="image/webp">
                                <img class="banner-header__petal-03"
                                    src="{{ asset("$design/images/decor/petal-3.png") }}" width="36"
                                    height="107">
                            </picture>
                            <picture>
                                <source srcset="{{ asset("$design/images/decor/family.webp") }}" type="image/webp">
                                <img class="banner-header__family"
                                    src="{{ asset("$design/images/decor/family.png") }}" width="247"
                                    height="166">
                            </picture>
                        </div>
                    </div>
                ...
                <div class="header__search search-bar" data-dev>
                    <form class="search search-bar__input search-form" action="{{ route('search.search_product') }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="search__input">
                            <input autocomplete="off" id="autocomplete" type="text" name="search_text"
                                data-error="Error" placeholder="{{ __('text.common_search_herbal') }}">
                        </div>
            ...
            <div class="footer__container">
                <div class="footer__inner">
                    <ul class="footer__row footer__row--large">
                        <li class="footer__item"><a href="tel:{{ __('text.phones_title_phone_1') }}"
                                class="footer__phone">{{ __('text.phones_title_phone_1_code') }}{{ __('text.phones_title_phone_1') }}</a>
                        </li>
                        <li class="footer__item"><a href="tel:{{ __('text.phones_title_phone_2') }}"
                                class="footer__phone">{{ __('text.phones_title_phone_2_code') }}{{ __('text.phones_title_phone_2') }}</a>
                        </li>
                        <li class="footer__item"><a href="tel:{{ __('text.phones_title_phone_3') }}"
                                class="footer__phone">{{ __('text.phones_title_phone_3_code') }}{{ __('text.phones_title_phone_3') }}</a>
                        </li>
                        <li class="footer__item"><a href="tel:{{ __('text.phones_title_phone_4') }}"
                                class="footer__phone">{{ __('text.phones_title_phone_4_code') }}{{ __('text.phones_title_phone_4') }}</a>
                        </li>
                        <li class="footer__item"><a href="tel:{{ __('text.phones_title_phone_5') }}"
                                class="footer__phone">{{ __('text.phones_title_phone_5_code') }}{{ __('text.phones_title_phone_5') }}</a>
                        </li>
                        <li class="footer__item"><a href="tel:{{ __('text.phones_title_phone_6') }}"
                                class="footer__phone">{{ __('text.phones_title_phone_6_code') }}{{ __('text.phones_title_phone_6') }}</a>
                        </li>
                        <li class="footer__item"><a href="tel:{{ __('text.phones_title_phone_7') }}"
                                class="footer__phone">{{ __('text.phones_title_phone_7_code') }}{{ __('text.phones_title_phone_7') }}</a>
                        </li>
                    </ul>
                    <ul class="footer__row">
                        <li class="footer__item"><a href="{{ route('home.index') }}"
                                class="footer__link">{{ __('text.common_best_sellers_main_menu_item') }}</a></li>
                        <li class="footer__item"><a href="{{ route('home.about') }}"
                                class="footer__link">{{ __('text.common_about_us_main_menu_item') }}</a></li>
                        <li class="footer__item"><a href="{{ route('home.help') }}"
                                class="footer__link">{{ __('text.common_help_main_menu_item') }}</a></li>
                        <li class="footer__item"><a href="{{ route('home.testimonials') }}"
                                class="footer__link">{{ __('text.common_testimonials_main_menu_item') }}</a></li>
                        <li class="footer__item"><a href="{{ route('home.delivery') }}"
                                class="footer__link">{{ __('text.common_shipping_main_menu_item') }}</a></li>
                        <li class="footer__item"><a href="{{ route('home.moneyback') }}"
                                class="footer__link">{{ __('text.common_moneyback_main_menu_item') }}</a></li>
                        <li class="footer__item"><a href="{{ route('home.contact_us') }}"
                                class="footer__link">{{ __('text.common_contact_us_main_menu_item') }}</a></li>
                        <li class="footer__item"><a href="{{ route('home.login') }}" class="footer__link"
                                target="_blank">{{ __('text.common_profile') }}</a></li>
                    </ul>
                    ...
                    <picture>
                        <source srcset="{{ asset("$design/images/decor/petal-footer.webp") }}" type="image/webp">
                        <img class="footer__petal" src="{{ asset("$design/images/decor/petal-footer.png") }}"
                            width="44" height="71">
                    </picture>
                    <picture>
                        <source srcset="{{ asset("$design/images/decor/petal-footer-02.webp") }}" type="image/webp">
                        <img class="footer__petal-02" src="{{ asset("$design/images/decor/petal-footer-02.png") }}"
                            width="96" height="107">
                    </picture>
                </div>
            </div>
