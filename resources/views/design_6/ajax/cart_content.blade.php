<div class="top-line">
    <h1 class="top-line__title title" id="scroll">{{__('text.cart_cart_title')}}</h1>
</div>
<div class="cart-page__order order">
                ...
                <div class="order__line">
                    <div class="order__row">
                        <div class="order__package" id = "{{ $product['product_id'] }}">
                            <span class="details-page-product">
                                {{-- <a href="{$path.page}/{$cur_product_in_cart_info.url}" style="font-weight: lighter;">{$cur_product_in_cart_info.name}</a> --}}
                                {{ $product['name'] }}
                            </span>
                        </div>
                ...
                <div class="bonus-line__items">
                    <div class="bonus-line__item">
                        <div class="checkbox">
                            ...
                            <label for="0" class="checkbox__label">
                    ...
                    <div class="bonus-line__item">
                        <div class="checkbox">
                            ...
                            <label for="11630" class="checkbox__label">
                    ...
                    <div class="bonus-line__item">
                        <div class="checkbox">
                            ...
                            <label for="4576" class="checkbox__label">
                                <span class="order-bonus__content">
                                    <span class="order-bonus__name">
                    ...
                    <div class="bonus-line__item">
                        <div class="checkbox">
                            ...
                            <label for="4577" class="checkbox__label">
                                <span class="order-bonus__content">
                                    <span class="order-bonus__name">
                    ...
                    <div class="bonus-line__item">
                        <div class="checkbox">
                            ...
                            <label for="4919" class="checkbox__label">
                                <span class="order-bonus__content">
                                    <span class="order-bonus__name">
                    ...
                    <div class="bonus-line__item">
                        <div class="checkbox">
                            ...
                            <label for="11656" class="checkbox__label">
                                <span class="order-bonus__content">
                                    <span class="order-bonus__name">
                    ...
                    <div class="bonus-line__item">
                        <div class="checkbox">
                            ...
                            <label for="11655" class="checkbox__label">
                                <span class="order-bonus__content">
                                    <span class="order-bonus__name">
    ...
    <div class="order__bottom actions-line">
        <a href="{{ route('home.index') }}" class="actions-line__button button button--stroke">{{__('text.cart_back_to_shop')}}</a>
        <a href="chekout.html" class="actions-line__button button button--filled">{{__('text.cart_pay_button')}}</a>
    </div>
</div>