    ...
    <section class="page__products home-grid-items">
        ...
        @if (count($products) == 0)
            <div class="home-grid-items__container">
                <h2 class="home-grid-items__title title">{{__('text.search_result_nothing_found1')}} «{{ $search_text }}» {{__('text.search_result_nothing_found2')}}</h2>
                <h2 class="home-grid-items__title title">{{__('text.search_result_best_for_search')}}</h2>
        ...
        @else
            <div class="home-grid-items__container">
                <h2 class="home-grid-items__title title">{{__('text.search_result_title_page')}}  «{{$search_text}}»</h2>
                <div class="home-grid-items__body">
