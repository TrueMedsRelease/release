...
@section('content')
<h1 class="content__title title" id="scroll">{{__('text.menu_title_sitemap')}}</h1>
<div class="text-page">
    <div style="margin-bottom: 20px; line-height: 25px;">
        <div style="font-size: 16px; margin-bottom: 20px;">{{ __('text.sitemap_site_info') }}:</div>
    ...
    <div style="margin-bottom: 20px">
        <div style="font-size: 16px; margin-bottom: 20px;">{{ __('text.category_title') }}:</div>
        <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 20px; line-height: 25px;">
            <div style="margin-left: 20px">
                <div>
                    <div class="site_info_url_item" >
                        <a class="site_info_link" href="{{ route('home.index') }}" style="font-size: 15px">
            ...
            @foreach ($menu as $category)
                <div style="margin-left: 20px">
                    <div>
                        <div class="site_info_url_item">
                            <a class="site_info_link" href="{{ route('home.category', $category['url']) }}" style="font-size: 15px">
                                {{ $category['name'] }}
                            </a>
                        </div>
                    </div>
    ...
    <div style="margin-bottom: 20px; line-height: 25px;">
        <div style="font-size: 16px; margin-bottom: 20px;">{{ __('text.sitemap_language_title') }}:</div>
        <div class="site_info_url_block" style="margin-left: 20px">
