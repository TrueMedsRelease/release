        ...
        <form class="form cart-form">
                                                        ...
                                                        <div class="qty-input">
                                                                ...
                                                                <span class="icon">
                                                                    @if (env('APP_PRINT_SPRITE', 1) == 1)
                                                                        <svg width="1em" height="1em" fill="currentColor">
                                                                            <use href="{{ asset($design . '/svg/icons/sprite.svg?pqvdu970#minus') }}"></use>
                                                                        </svg>
                                                                    @else
                                                            ...
                                                            <button class="qty-input__plus" type="button" aria-label="Plus" onclick="up({{ $product['pack_id'] }})">
                                                                <span class="icon">
                                                                    @if (env('APP_PRINT_SPRITE', 1) == 1)
                                                                        <svg width="1em" height="1em" fill="currentColor">
                                                                            <use href="{{ asset($design . '/svg/icons/sprite.svg?pqvdu970#plus') }}"></use>
                                                                        </svg>
                                                                    @else
                                                                        <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor">
                                                    ...
                                                    <td class="cart-item__remove" width="2.6%">
                                                        <button class="cart-remove" type="button" aria-label="Remove from cart" onclick="remove({{ $product['pack_id'] }})">
                                                            <span class="icon">
                                                                @if (env('APP_PRINT_SPRITE', 1) == 1)
                                                                    <svg width="1em" height="1em" fill="currentColor">
                                                                        <use href="{{ asset($design . '/svg/icons/sprite.svg?pqvdu970#trash') }}"></use>
                                                                    </svg>
                                                                @else
                        ...
                        <div class="delivery-radios grey-panel">
                            @if ($shipping['ems'] != 0)
                                <div class="form-radio-wrapper">
                                    <input class="form-radio-input" id="delivery-2" type="radio" name="delivery" value="ems" @if (session('cart_option.shipping', env('APP_DEFAULT_SHIPPING')) == 'ems') checked @endif onchange="change_shipping('ems', {{ $product_total_check >= 300 ? 0 : $shipping['ems'] }})">
                            ...
                            @if ($shipping['regular'] != 0)
                                <div class="form-radio-wrapper">
                                    <input class="form-radio-input" id="delivery-1" type="radio" name="delivery" value="regular" @if (session('cart_option.shipping', env('APP_DEFAULT_SHIPPING')) == 'regular') checked @endif onchange="change_shipping('regular', {{ $product_total_check >= 200 ? 0 : $shipping['regular'] }})">
            ...
            <fieldset class="form__fieldset">
                <div class="form__field custom-field">
                    <div class="pack-radios grey-panel">
                        <div class="form-radio-wrapper">
                            <input class="form-radio-input" id="pack-0" type="radio" name="pack" @checked(session('cart_option.bonus_id', 0) == 0) onchange="change_bonus(0, 0)" value="0">
                        ...
                        @foreach ($bonus as $product)
                            <div class="form-radio-wrapper">
                                <input class="form-radio-input" id="pack-{{ $loop->iteration + 1 }}" type="radio" name="pack" @checked(session('cart_option.bonus_id', 0) == $product->pack_id) onchange="change_bonus({{ $product->pack_id }}, {{ $product->price }})" value="{{ $product->pack_id }}">
            ...
            @if (env('APP_GIFT_CARD') == 1)
                @if (!$has_card)
                                ...
                                <div class="gift_block grey-panel cart-form-gift">
                                    ...
                                    <div class="gift-card-balance">
                                        ...
                                        <div id="new_gift_block">
                                            ...
                                            <button class="button button--uppercase button--secondary" type="button" onclick="addCard()">{{__('text.common_add_to_cart_text_d2')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    {{-- <fieldset class="form__fieldset">
                        <div class="form__field custom-field">
                            <div class="grey-panel cart-form-gift">
                                <div class="add-gift-card">
                                    <div class="order-option__checkbox">
                                        <input class="form__checkbox" id="gift-card-checkbox" type="checkbox">
                                        <label class="form__label form__label--checkbox" for="gift-card-checkbox">
                                ...
                                <div class="gift-card-balance">
                                    ...
                                    <div class="gift-card-wrapper">
                                        <div class="select-wrapper">
                                            <select class="select" id="select_item_gift">
                                                @foreach ($cards as $card)
                                        ...
                                        <button class="button button--secondary button--uppercase" type="button" onclick="addCard()">{{__('text.common_add_to_cart_text_d2')}}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <article class="card">
                    ...
                    <div class="card-features">
                        ...
                        <div class="card-feature">
                            <picture>
                                <source type="image/webp" srcset="{{$design}}/img/brands/brand-1-48w.webp 1x,{{$design}}/img/brands/brand-1-97w.webp 2x">
                                <img src="{{$design}}/img/brands/brand-1-48w.png"
                                srcset="{{$design}}/img/brands/brand-1-48w.png 1x,{{$design}}/img/brands/brand-1-97w.png 2x" width="49" height="32"
                                alt="Product feature">
                            </picture>
                        </div>
                        <div class="card-feature">
                            <picture>
                                <source type="image/webp" srcset="{{$design}}/img/brands/brand-2-46w.webp 1x,{{$design}}/img/brands/brand-2-93w.webp 2x">
                                <img src="{{$design}}/img/brands/brand-2-46w.png"
                                srcset="{{$design}}/img/brands/brand-2-46w.png 1x,{{$design}}/img/brands/brand-2-93w.png 2x" width="47" height="36"
                                alt="Product feature">
                            </picture>
                        </div>
                    </div>
