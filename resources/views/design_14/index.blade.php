...
<div class="page-wrapper container">
    <main class="main">
        <div class="customers-choice-block">
            <div class="customers-choice">
                <div class="customers-choice__title">1 000 000</div>
                <div class="customers-choice__text">{{ __('text.common_customers') }}</div>
                <div class="customers-choice__img">
                    <picture>
                        <source type="image/webp" media="(min-width: 26.9375em) and (min-width: 431px)"
                        srcset="{{ asset("$design/img/layout/customers-choice-md-198w.webp 1x, $design/img/layout/customers-choice-md-396w.webp 2x") }}">
                        <source type="image/png" media="(min-width: 26.9375em) and (min-width: 431px)"
                        srcset="{{ asset("$design/img/layout/customers-choice-md-198w.png 1x, $design/img/layout/customers-choice-md-396w.png 2x") }}">
                        <source type="image/webp"
                        srcset="{{ asset("$design/img/layout/customers-choice-150w.webp 1x, $design/img/layout/customers-choice-300w.webp 2x") }}"><img
                        src="{{ asset("$design/img/layout/customers-choice-150w.png") }}"
                        srcset="{{ asset("$design/img/layout/customers-choice-150w.png 1x, $design/img/layout/customers-choice-300w.png 2x") }}" width="150"
                        height="40" alt="Customers choice">
                    </picture>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-features">
                                ...
                                <div class="card-feature">
                                    <picture>
                                        ...
                                        srcset="{{ asset("$design/img/brands/brand-1-48w.png") }} 1x, {{ asset("$design/img/brands/brand-1-97w.png 2x") }}" width="49" height="32"
                                        alt="Product feature">
                                    </picture>
                                </div>
                                <div class="card-feature">
                                    <picture>
                                        ...
                                        srcset="{{ asset("$design/img/brands/brand-2-46w.png") }} 1x, {{ asset("$design/img/brands/brand-2-93w.png 2x") }}" width="47" height="36"
                                        alt="Product feature">
                                    </picture>
                                </div>
                            </div>
